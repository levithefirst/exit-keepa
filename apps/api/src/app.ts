...
import { safeAuthorizationRouter } from "./routes/safeAuthorization";
...
export function createApp() {
  ...
  app.use(cors({ origin: allowAllOrigins ? true : env.CORS_ORIGINS.length > 0 ? env.CORS_ORIGINS : false }));
  ...
  app.use("/api", safeAuthorizationRouter);
